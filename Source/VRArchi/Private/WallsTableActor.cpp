...
AWallsTableActor::AWallsTableActor()
{
	// Set this actor to call Tick() every frame.  You can turn this off to improve performance if you don't need it.
	PrimaryActorTick.bCanEverTick = true;

	ConstructorHelpers::FObjectFinder<UDataTable> walldatatable_BP(TEXT("DataTable '/Game/JSon/WallsCSV.WallsCSV'"));

	if (walldatatable_BP.Object)
	{
		...
		mydatatable = walldatatable_BP.Object;
	}

}

// Called when the game starts or when spawned
void AWallsTableActor::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void AWallsTableActor::Tick(float DeltaTime)
{
	Super::Tick(DeltaTime);

}

UDataTable* AWallsTableActor::ReadCsvFile(FString csvPath)
{
